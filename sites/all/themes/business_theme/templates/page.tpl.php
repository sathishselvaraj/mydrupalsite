...
<header id="header">
  ...
  <div class="header_wrapper">
    <div class="header_wrapper_inner">
      ...
      <?php if (theme_get_setting('socialicon_display', 'business_theme')): ?>
        <?php 
        $twitter_url = check_plain(theme_get_setting('twitter_url', 'business_theme')); 
        $facebook_url = check_plain(theme_get_setting('facebook_url', 'business_theme')); 
        $google_plus_url = check_plain(theme_get_setting('google_plus_url', 'business_theme')); 
        $pinterest_url = check_plain(theme_get_setting('pinterest_url', 'business_theme'));
        ?>
